...
if __name__ == '__main__':
    ...
    # lock1 = RLock()
    # lock2 = RLock()
    # accounts_default = (["0x6f01Df94aD13495c9CDe2dc2aE272e5e559834B4",
    ...
    accounts = (["0x002491c91e81da1643de79582520ac4c77229e58",
    ...
    tests.add_test("deploy", ("SimpleStore.sol", accounts[1]))
    # tests.add_test("chckserver", (20,), accounts=accounts)
    # tests.add_test("sametrans", (lock2, param))
    # tests.add_test("new_acc")
